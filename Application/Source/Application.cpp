...
{
	sceneNum = SCENE_TEXT; // Initialise the variable
...
void Application::Run()
{
	...
	//Scene* scene2 = new SceneLightSource();
	//Scene* scene = scene1;
	scene->Init();
	...
	while (!glfwWindowShouldClose(m_window) && !IsKeyPressed(VK_ESCAPE))
	{
		...
		//		scene = scene2;
		//		sceneNum = SCENE_LIGHTSOURCE;
		//	}
		//	else if (sceneNum == SCENE_LIGHTSOURCE) {
		//		scene2->Exit();
		//		scene1->Init();
		//		scene = scene1;
		//		sceneNum = SCENE_1;

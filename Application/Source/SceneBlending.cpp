...
void SceneBlending::Init()
{
	...
	meshList[GEO_BLEND] = MeshBuilder::GenerateQuad("Plane", Color(1.f, 1.f, 1.f), 100.f);
...
void SceneBlending::Update(double dt)
{
	HandleKeyPress();
...
void SceneBlending::RenderMesh(Mesh* mesh, bool enableLight)
{
...
void SceneBlending::RenderSkyBox()
{
	modelStack.PushMatrix();
...
void SceneBlending::HandleKeyPress()
{
